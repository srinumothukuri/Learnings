...
(function () {
    ...
    extend(Chart.Type.prototype, {
        ...
        generateLegend: function () {
            return helpers.template(this.options.legendTemplate, {datasets: this.datasets, segments: this.segments});
        },
        destroy: function () {
            this.stop();
            this.clear();
...
(function () {
    ...
    var defaultConfig = {
        ...
        //String - A legend template
        legendTemplate: "<ul class=\"default-legend\"><% for (var i=0; i<segments.length; i++){%><li><span class=\"bullet\" style=\"background-color:<%=segments[i].fillColor%>\"></span><span><%if(segments[i].label){%><%=segments[i].label%><%}%> - <%if(segments[i].value != undefined && segments[i].value != -1){%><%=segments[i].value /1000%> GB<%}%><%if(segments[i].value == -1){%><%='N/A'%><%}%></span></li><%}%></ul>"
