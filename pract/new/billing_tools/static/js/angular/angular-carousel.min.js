...
angular.module("angular-carousel", ["ngTouch", "angular-carousel.shifty"]), angular.module("angular-carousel").directive("rnCarouselAutoSlide", ["$interval", function (a) {
    ...
    return{restrict: "A", scope: {slides: "=", index: "=rnCarouselIndex"}, templateUrl: "carousel-indicators.html", link: function (b, c, d) {
    ...
    angular.module("angular-carousel").service("DeviceCapabilities", function () {
        ...
        function b() {
            var a, b = document.createElement("p"), c = {webkitTransform: "-webkit-transform", msTransform: "-ms-transform", transform: "transform"};
        ...
        return{restrict: "A", scope: !0, compile: function (m, n) {
            ...
            return["ng-repeat", "data-ng-repeat", "ng:repeat", "x-ng-repeat"].every(function (a) {
                ...
                function r(a) {
                    M = !0, C({x: a.clientX, y: a.clientY}, a)
                }

                function u(a) {
                    var b = 100 * m.carouselBufferIndex + a;
                    angular.forEach(q(), function (a, c) {
                        a.style.cssText = i(h(c, b, J.transitionType))
                    })
                }

                function v(a, b) {
                    if (void 0 === a && (a = m.carouselIndex), b = b || {}, b.animate === !1 || "none" === J.transitionType)return R = !1, L = -100 * a, m.carouselIndex = a, D(), void 0;
                    R = !0;
                    var c = new j;
                    c.tween({from: {x: L}, to: {x: -100 * a}, duration: J.transitionDuration, easing: J.transitionEasing, step: function (a) {
                        u(a.x)
                    }, finish: function () {
                        m.$apply(function () {
                            m.carouselIndex = a, L = -100 * a, D(), f(function () {
                                R = !1
                            }, 0, !1)
                        })
                    }})
                ...
                function y() {
                    Q || (Q = !0, c.bind("mouseup", r))
                }

                function z() {
                    Q && (Q = !1, c.unbind("mouseup", r))
                }

                function A(a) {
                    return R || N.length <= 1 ? void 0 : (x(), P = n[0].querySelector("li").getBoundingClientRect().left, F = !0, G = a.x, !1)
                }

                function B(a) {
                    var b, c;
                    if (y(), F && (b = a.x, c = G - b, c > 2 || -2 > c)) {
                        M = !0;
                        var d = L + 100 * -c / O;
                        u(d)
                    }
                ...
                function C(a, b) {
                    if ((!b || M) && (z(), F = !1, M = !1, H = G - a.x, 0 !== H && !R))if (L += 100 * -H / O, J.isSequential) {
                        var c = J.moveTreshold * O, d = -H, e = -Math[d >= 0 ? "ceil" : "floor"](d / O), f = Math.abs(d) > c;
                        N && e + m.carouselIndex >= N.length && (e = N.length - 1 - m.carouselIndex), e + m.carouselIndex < 0 && (e = -m.carouselIndex);
                        var g = f ? e : 0;
                        H = m.carouselIndex + g, v(H)
                    } else m.$apply(function () {
                        m.carouselIndex = parseInt(-L / 100, 10), D()
                    })
                }

                function D() {
                    var a = 0, b = (m.carouselBufferSize - 1) / 2;
                    t ? (a = m.carouselIndex <= b ? 0 : N && N.length < m.carouselBufferSize ? 0 : N && m.carouselIndex > N.length - m.carouselBufferSize ? N.length - m.carouselBufferSize : m.carouselIndex - b, m.carouselBufferIndex = a, f(function () {
                        u(L)
                    }, 0, !1)) : f(function () {
                        u(L)
                    }, 0, !1)
                ...
                l++;
                var F, G, H, I = {transitionType: o.rnCarouselTransition || "slide", transitionEasing: o.rnCarouselEasing || "easeTo", transitionDuration: parseInt(o.rnCarouselDuration, 10) || 300, isSequential: !0, autoSlideDuration: 3, bufferSize: 5, moveTreshold: .1}, J = angular.extend({}, I), K = !1, L = 0, M = !1, N = [], O = null, P = null, Q = !1, R = !1;
                a.bind(n, {start: A, move: B, end: C, cancel: function (a) {
                    C({}, a)
                }}), m.nextSlide = function (a) {
                    var b = m.carouselIndex + 1;
                    b > N.length - 1 && (b = 0), R || v(b, a)
                }, m.prevSlide = function (a) {
                    var b = m.carouselIndex - 1;
                    0 > b && (b = N.length - 1), v(b, a)
                };
                var S = !0;
                if (m.carouselIndex = 0, s || (N = [], angular.forEach(q(), function (a, b) {
                    N.push({id: b})
                })), void 0 !== o.rnCarouselControls) {
                    var T = s ? p.replace("::", "") + ".length - 1" : N.length - 1, U = '<div class="rn-carousel-controls">\n  <span class="rn-carousel-control rn-carousel-control-prev" ng-click="prevSlide()" ng-if="carouselIndex > 0"></span>\n  <span class="rn-carousel-control rn-carousel-control-next" ng-click="nextSlide()" ng-if="carouselIndex < ' + T + '"></span>\n</div>';
                    n.append(e(angular.element(U))(m))
                }
                if (void 0 !== o.rnCarouselAutoSlide) {
                    var V = parseInt(o.rnCarouselAutoSlide, 10) || J.autoSlideDuration;
                ...
                if (o.rnCarouselIndex) {
                    var W = function (a) {
                        X.assign(m.$parent, a)
                    }, X = d(o.rnCarouselIndex);
                    angular.isFunction(X.assign) ? (m.$watch("carouselIndex", function (a) {
                        W(a)
                    }), m.$parent.$watch(X, function (a) {
                        void 0 !== a && null !== a && (N && a >= N.length ? (a = N.length - 1, W(a)) : N && 0 > a && (a = 0, W(a)), R || v(a, {animate: !S}), S = !1)
                    }), K = !0) : isNaN(o.rnCarouselIndex) || v(parseInt(o.rnCarouselIndex, 10), {animate: !1})
                } else v(0, {animate: !S}), S = !1;
                if (o.rnCarouselLocked && m.$watch(o.rnCarouselLocked, function (a) {
                    R = a === !0 ? !0 : !1
                }), s) {
                    var Y = void 0 !== o.rnCarouselDeepWatch;
                    m[Y ? "$watch" : "$watchCollection"](p, function (a, b) {
                        if (N = a, Y && angular.isArray(a)) {
                            var c = b[m.carouselIndex], d = k(a, c, m.carouselIndex);
                            v(d, {animate: !1})
                        } else v(m.carouselIndex, {animate: !1})
                    }, !0)
                }
                m.$on("$destroy", function () {
                    z()
                }), m.carouselBufferIndex = 0, m.carouselBufferSize = J.bufferSize;
                var Z = angular.element(b);
                Z.bind("orientationchange", E), Z.bind("resize", E), m.$on("$destroy", function () {
                    z(), Z.unbind("orientationchange", E), Z.unbind("resize", E)
                })
            }
        }}
    }])
    ...
    return function (a) {
        var b = function () {
            ...
            }, k.prototype.filter = {}, k.prototype.formula = {linear: function (a) {
                return a
            }}, l = k.prototype.formula, d(k, {now: r, each: c, tweenProps: f, tweenProp: g, applyFilter: h, shallowCopy: d, defaults: e, composeEasingObject: j}), a.Tweenable = k, k
        }();
        !function () {
            b.shallowCopy(b.prototype.formula, {easeInQuad: function (a) {
                return Math.pow(a, 2)
