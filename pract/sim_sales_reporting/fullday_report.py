...
e={}
count=1
filepath1 = f'/home/ubuntu/summary/sim_sales_{yesterday}_fullday.csv'
filepath2 = f'/home/ubuntu/summary/retailers_{yesterday}_fullday.csv'
...
subprocess.run(['python3', '/home/ubuntu/sim_sales_reporting/fullday_mail.py'])
